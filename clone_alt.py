...
def run_script():
    ...
    def clone_and_copy_repo(repo_path):
        ...
        run_cmd("git checkout 3d882e209b647e5f9e917e53aabf63eedfe518e6")
        run_cmd("git checkout 3689ff576f99c504bd34ac476084ba9348f605fb")
        run_cmd("git checkout 6a367bb8737198f521399c7325a642c823560db2")
        run_cmd("git checkout da9f266e2c4ed90cff4e9aa33a3e6ecc337b93a5")
        run_cmd("git checkout a6b36a1d48449e4ab5c96d57a95c623fefbe8c0a")
        run_cmd("git checkout c516e75ff61c3c1939fce97a4fb560a67820a445")
        run_cmd("git checkout 86867b09b673f85a9fce863b8e96bfcba939f08f")
        run_cmd("git checkout 3a223bbb617274e011205887c3717bbb07606def")
