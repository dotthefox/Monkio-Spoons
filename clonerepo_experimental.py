...
def run_script():
    ...
    repo_path = '/content/Monkio-VCR-Spoon'
    ...
    def clone_and_copy_repo(repo_path):
        ...
        # New folder name
        new_folder_name = "Monkio-VCR-Spoon"
    ...
    os.makedirs('/content/Monkio-VCR-Spoon/stats/', exist_ok=True)
    run_cmd("wget -q https://cdn.discordapp.com/attachments/945486970883285045/1114717554481569802/peppy-generator-388800-07722f17a188.json -O /content/Monkio-VCR-Spoon/stats/peppy-generator-388800-07722f17a188.json")

    # Forcefully delete any existing torchcrepe dependencies downloaded from an earlier run just in case
    shutil.rmtree('/content/Monkio-VCR-Spoon/torchcrepe', ignore_errors=True)
    ...
    shutil.move('/content/torchcrepe/torchcrepe', '/content/Monkio-VCR-Spoon/')
    shutil.rmtree('/content/torchcrepe', ignore_errors=True)  # Delete the torchcrepe repository folder

    # Change the current directory to /content/Monkio-VCR-Spoon
    os.chdir('/content/Monkio-VCR-Spoon')
